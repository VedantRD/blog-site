                ...
                <div className="card-header">
                    ...
                    <div className='row align-items-center my-2'>
                        ...
                        <div className='col-lg-10 col-md-4 profileusername'>
                            <h3 className="card-title my-0 d-inline">Geek_VD99</h3>
                            ...
                            <div className="row no-gutters align-items-center">
                                ...
                                <p className="badge bg-info mr-2 px-3 text-light py-2" style={{ fontSize: 15 }}>React</p>
                                <p className="badge bg-info mr-2 px-3 text-light py-2" style={{ fontSize: 15 }}>Node</p>
                                <p className="badge bg-info mr-2 px-3 text-light py-2" style={{ fontSize: 15 }}>Express</p>
                                <p className="badge bg-info mr-2 px-3 text-light py-2" style={{ fontSize: 15 }}>Mongo</p>
                            </div>
                        </div>
                    </div>
                    <hr className=''></hr>
                    ...
                    <div className='row no-gutters justify-content-sm-center justify-content-lg-end text-center mx-0 px-0 align-items-center'>
                        <div className='col-lg-4'>
                            <div className='row justify-content-start align-items-center no-gutters pl-4 editprof'>
                        ...
                        <div className='col-lg-8'>
                            <div className='row justify-content-end no-gutters'>
                                ...
                                <div className='col-lg-2 col-sm-4'>
                                    <h5 className="font-weight-bold mb-0 d-block">110</h5>
                    ...
                    <div className="row">
                        ...
                        <div className='col-lg-6'>
                            <div className='card'>
                                ...
                                <div className='card-body'>
                                    <div>
                                        <p className='card-text'>Fullname : Vedant Debadwar</p>
                                        <p className='card-text'>Nationality : India</p>
